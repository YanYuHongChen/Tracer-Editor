...
public:
  ...
  u8 *getExtraData() const { return extraData; }
  ...
  bool toE16(float *scale, float *bias, const bool useAllSameRange = false, const float minValue = MIN_F32, const float maxValue = MAX_F32);
