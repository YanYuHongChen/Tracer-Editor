...
*/
extern void VerifyD3D11ShaderResult(class RBRHIShader* Shader, HRESULT Result, const char* Code, const char* Filename, uint32 Line, ID3D11Device* Device);
...
* @param	Line - The line number of Code within Filename.
*/
extern void VerifyD3D11CreateTextureResult(HRESULT D3DResult, const char* Code, const char* Filename, uint32 Line,
...
struct FD3D11LockedData
{
  ...
  {
    Data = (uint8*)::rb_align_malloc(Size, 16);
